<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AddParts.aspx.cs" Inherits="BookOnlineSupplierParts_Add"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" Runat="Server">
    <form runat="server" class="form-horizontal">        
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <label class="control-label col-lg-3">Desired Entry Date:</label>
                <div class="col-lg-8">
                    <asp:TextBox ID="calEntryDate" class="form-control" type="date" runat="server" />
                </div>
            </div>
            <h4>Select Parts</h4>
