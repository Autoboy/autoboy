<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Paint_Default" %>
                    ...
                    <asp:ListView ID="lvUsers" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%# Eval("Supplier") %></td>
                                <td>
                                    <a href='Details.aspx?ID=<%# Eval("PaintID") %>'><i class="fa fa-search"></i></a>&nbsp;
                                    <a href='Delete.aspx?ID=<%# Eval("PaintID") %>' onclick='return confirm("Delete record?")'>
