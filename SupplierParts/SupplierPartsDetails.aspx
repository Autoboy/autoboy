<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SupplierPartsDetails.aspx.cs" Inherits="SupplierParts_Add"  %>
                    ...
                    <table  class="table table-hover">
                        ...
                        <tbody>
                            <asp:ListView ID="lvSpecView" runat="server" OnItemCommand="lvSpecView_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        <td><%# Eval("PartName") %><asp:Literal id="ltPartID" runat="server" Text='<%# Eval("PartID") %>' Visible="false" /><asp:Literal id="ltSpecificID" runat="server" Text='<%# Eval("SpecificID") %>' Visible="false" /></td>
                                        <td><%# Eval("Year") %></td>
            ...
            <table  class="table table-hover">
                ...
                <tbody>
                    <asp:ListView ID="lvSupplierPart" runat="server" OnItemCommand="lvSupplierPart_ItemCommand" >
                        <ItemTemplate>
                            <tr>
                                <td><%# Eval("PartName") %><asp:Literal id="ltRefID" runat="server" Text='<%# Eval("RefID") %>' Visible="false" /></td>
                                <td><%# Eval("Year") %></td>
                                <td><%# Eval("EstPrice", "{0: #,###.00}") %></td>
                                <td><%# Eval("EstTime") %></td>
